    ...
    return (
        ...
        <div className={classes.footer}>
            ...
            >
                ...
                <Link href="https://github.com/Kingly77" color="inherit" underline={'none'}>
                ...
                <Link href="https://github.com/JR1994-CA" color="inherit" underline={'none'}>
                    <Avatar alt="Jesus Ramirez Arroyo" variant="square" src="/broken-image.jpg" className={classes.orange}>J</Avatar>
                </Link>
                </Tooltip>
                {/*<Tooltip title="Shelby Jordan" TransitionComponent={Fade} TransitionProps={{ timeout: 600 }}>*/}
                {/*<Link href="https://github.com/AustinJohnAaro  color="inherit" underline={'none'}>*/}
                ...
                <Link href="https://github.com/CynthiaMohan" color="inherit" underline={'none'}>
